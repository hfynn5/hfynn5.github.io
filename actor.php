...
<br>
  ...
  <?php require_once 'processactor.php'; ?>
  <?php
  ...
  <form action="processactor.php" method="POST">
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="actor.php?edit=<?php echo $row['actor_id']; ?>" class="btn btn-info">Edit</a>
              <a href="actor.php?delete=<?php echo $row['actor_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
