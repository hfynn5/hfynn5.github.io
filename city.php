...
<br>
  ...
  <?php require_once 'processcity.php'; ?>
  <?php
  ...
  <form action="processcity.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID; ?>" readonly="readonly">
      ...
      <div class="form-group">
        ...
        <input type="text" name="countryID" class="form-control" value="<?php echo $countryID ?>" placeholder="Enter Country">
      </div>
      <div class="form-group">
        <?php
        if($update == true):
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="city.php?edit=<?php echo $row['city_id']; ?>" class="btn btn-info">Edit</a>
              <a href="city.php?delete=<?php echo $row['city_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
