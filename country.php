...
<br>
  ...
  <?php require_once 'processcountry.php'; ?>
  <?php
  ...
  <form action="processcountry.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID; ?>" readonly="readonly">
      <div class="form-group">
        <label>Country ID</label>
        <input type="text" name="id" class="form-control" value="<?php echo $ID ?>" placeholder="Enter Country ID">
      </div>
      <div class="form-group">
        <label>Country</label>
        <input type="text" name="country" class="form-control" value="<?php echo $country ?>" placeholder="Enter Country">
      </div>
      <div class="form-group">
        <?php
        if($update == true):
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="country.php?edit=<?php echo $row['country_id']; ?>" class="btn btn-info">Edit</a>
              <a href="country.php?delete=<?php echo $row['country_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
