...
<br>
  ...
  <?php require_once 'processfilmcategory.php'; ?>
  <?php
  ...
  <form action="processfilmcategory.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID; ?>" readonly="readonly">
      ...
      <div class="form-group">
        ...
        <input type="text" name="categoryID" class="form-control" value="<?php echo $categoryID ?>" placeholder="Enter Category ID">
      </div>
      <div class="form-group">
        <?php
        if($update == true):
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="film_category.php?edit=<?php echo $row['film_id']; ?>" class="btn btn-info">Edit</a>
              <a href="film_category.php?delete=<?php echo $row['film_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
