  ...
  <form action="processinventory.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID; ?>" readonly="readonly">
      <div class="form-group">
        ...
        <input type="text" name="id" class="form-control" value="<?php echo $ID ?>" placeholder="Enter Inventory ID">
      </div>
      <div class="form-group">
        <label>Film ID</label>
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="inventory.php?edit=<?php echo $row['inventory_id']; ?>" class="btn btn-info">Edit</a>
              <a href="inventory.php?delete=<?php echo $row['inventory_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
