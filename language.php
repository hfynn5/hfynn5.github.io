...
<br>
  ...
  <?php require_once 'processlanguage.php'; ?>
  <?php
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="language.php?edit=<?php echo $row['language_id']; ?>" class="btn btn-info">Edit</a>
              <a href="language.php?delete=<?php echo $row['language_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
