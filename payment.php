...
<br>
  ...
  <?php require_once 'processpayment.php'; ?>
  <?php
  ...
  <form action="processpayment.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID; ?>" readonly="readonly">
      <div class="form-group">
        ...
        <input type="text" name="id" class="form-control" value="<?php echo $ID ?>" placeholder="Enter Payment ID">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" name="rentalID" class="form-control" value="<?php echo $rentalID ?>" placeholder="Enter Rental ID">
      </div>
			<div class="form-group">
        <label>Amount</label>
        ...
        <input type="datetime-local" name="paymentdate" class="form-control" value="<?php echo $paymentdate ?>" placeholder="Enter Payment Date">
      </div>
      <div class="form-group">
        <?php
        if($update == true):
