...
<br>
  ...
  <?php require_once 'processstore.php'; ?>
  <?php
  ...
  <form action="processstore.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID; ?>" readonly="readonly">
      <div class="form-group">
        <label>Store ID</label>
        <input type="text" name="id" class="form-control" value="<?php echo $ID ?>" placeholder="Enter Store ID">
      </div>
      <div class="form-group">
        <label>Manager Staff ID</label>
        <input type="text" name="managerstaffID" class="form-control" value="<?php echo $managerstaffID ?>" placeholder="Enter Manager Staff ID">
      </div>
      <div class="form-group">
  ...
  <div class="container">
    ...
    <tr>
      ...
      <th class="th-sm">Manager Staff ID</th>
  ...
  <?php
        while($row = $result->fetch_assoc()): ?>
          <tr>
              ...
              <td><center><a href="store.php?edit=<?php echo $row['store_id']; ?>" class="btn btn-info">Edit</a>
              <a href="store.php?delete=<?php echo $row['store_id']; ?>" class="btn btn-danger">Delete</a></center></td>
          </tr>
        <?php endwhile; ?>
      </table>
  </div>
